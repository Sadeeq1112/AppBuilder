  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
            <a href="{{ url('/admin')}}" class="nav-link @if(URL::full()==url('/')) active @endif">
        ...
        <li class="nav-item" >                          
            ...
            <li class="nav-item @if(Ch::isActive(['userprofile','general-settings']) || URL::full()==url('admin/translations')) menu-open @endif" >                          
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/general-settings') }}" class="nav-link @if(Ch::isActive('general-settings')) active @endif">
                      <i class="far fa-circle nav-icon"></i>
