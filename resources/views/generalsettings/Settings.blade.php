                ...
                <div class="x_content">
                    <form  ng-app="ngSettingsApp" ng-controller="ngSettingsAppcontroller" id="Settings-form" class="form-horizontal form-label-left" method="post" name='Settings-form' action='{!! route("GeneralSettingscreateorupdate") !!}' autocomplete="off">
                        ...
                        <div class="form-group">                            
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="locale">
                                    <option @if(Config::get('sysconfig.language')=='ar') selected @endif value="ar">@lang('general_settings.arabic')</option>
                                    <option @if(Config::get('sysconfig.language')=='en') selected @endif value="en">@lang('general_settings.english')</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">                            
